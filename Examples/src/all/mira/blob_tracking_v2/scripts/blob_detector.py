...
Moded by : RDaneelOlivaw form TheConstructSim
"""
...
class BlobTracker(object):
    ...
    def __init__(self):
        ...
        # x,y: x,y relative poses of teh center of the blob detected relative to the center of teh image
...
if __name__=="__main__":
    ...
    #--- Define HSV limits for RED Haro
    hsv_min = (0,234,0)
    hsv_max = (0, 255, 255) 
